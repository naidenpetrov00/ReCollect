namespace PackIT.Domain.Policies.Universal
{
	...
	internal sealed class BasicPolicy : IPackingItemsPolicy
	{
		...
		public IEnumerable<PackingItem> GenerateItems(PolicyData data)
			...
			{
				new PackingItem{Name ="Pants",Quantity= Math.Min(data.Days, MaximumQuantityOfClothes)},
				new PackingItem{Name ="Socks",Quantity= Math.Min(data.Days, MaximumQuantityOfClothes)},
				new PackingItem{Name ="T-Shirt",Quantity= Math.Min(data.Days, MaximumQuantityOfClothes)},
